...
if (myFavoriteNumbers.length < 7) {
  ...
  someNum = myFavoriteNumbers.splice[6 , 0 , someNum]
}
...
for (let i = 0; i <listOfNumbers.length; i++){
  if (listOfNumbers[i] % 3 === 0){console.log(listOfNumbers[i] + ' is divisible by 3')}
}
...
switch (letterGrade) {
  ...
  case 'F': Console.log("The student is failing.")
    break;
  default: console.log("Not an eligable grade")
    break;
}
